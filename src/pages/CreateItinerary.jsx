  ...
  return (
    <div className="min-h-screen bg-gradient-romantic">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        >
          <h1 className="font-display text-3xl font-bold text-ink mb-2">Plan a New Date</h1>
          <p className="text-ink-lighter mb-8">Create an itinerary for your next adventure together</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4">
              <Link to="/itineraries" className="btn btn-secondary flex-1">
                Cancel
              </Link>
